...
/*****************************************************************************
 * Function: main
 * Description: The main program which decodes a file
 * Inputs: N/A
...
int main(int argc, char** argv) {
  ...
  // Hardcoded filenames are a silly requirement, but it's what the spec says
  char filename[] = "compressed.bin";
  decode(filename, "decoded.txt", "tree.txt");  
